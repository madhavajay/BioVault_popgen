...
//
//   country_allele_freq  (BIOSYNTH_IMAGE, default ghcr.io/openmined/biosynth:0.1.32)
...
//
//   population_fst_aims  (ghcr.io/madhavajay/biovault-popgen:0.2.5-fast)
...
process population_fst_aims {
    container 'ghcr.io/madhavajay/biovault-popgen:0.2.5-fast'
