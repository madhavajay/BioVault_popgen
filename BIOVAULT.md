...
```
ghcr.io/madhavajay/biovault-popgen:0.1.4-fast
```

The full image is still built as `ghcr.io/madhavajay/biovault-popgen:0.1.4` for slow/Hail
...
2. **FST** — `container ghcr.io/madhavajay/biovault-popgen:0.1.4-fast`. Load/merge
...
`ghcr.io/madhavajay/biovault-popgen:0.1.4-fast` bakes:
...
`ghcr.io/madhavajay/biovault-popgen:0.1.4` bakes:
...
```bash
VERSION=0.1.4 ./build_docker.sh
```

This builds the full image first, then the fast image. It produces:

```text
ghcr.io/madhavajay/biovault-popgen:0.1.4
...
docker build --platform linux/amd64 \
  --target fast-runtime \
  -t ghcr.io/madhavajay/biovault-popgen:0.1.4-fast \
...
```bash
docker tag biovault-popgen:fast ghcr.io/madhavajay/biovault-popgen:0.1.4-fast
IMAGE=ghcr.io/madhavajay/biovault-popgen:0.1.4-fast ./03_individual_level.sh --qc 3
IMAGE=ghcr.io/madhavajay/biovault-popgen:0.1.4-fast ./03_individual_level.sh --fast 3
IMAGE=ghcr.io/madhavajay/biovault-popgen:0.1.4-fast ./03_individual_level.sh --sex 4
IMAGE=ghcr.io/madhavajay/biovault-popgen:0.1.4-fast ./04_population_level.sh --limit 1
```
...
```bash
IMAGE=ghcr.io/madhavajay/biovault-popgen:0.1.4 ./03_individual_level.sh --slow 3
IMAGE=ghcr.io/madhavajay/biovault-popgen:0.1.4 ./03_individual_level.sh --qc --slow 3
IMAGE=ghcr.io/madhavajay/biovault-popgen:0.1.4 ./03_individual_level.sh --sex --slow 4
IMAGE=ghcr.io/madhavajay/biovault-popgen:0.1.4 ./04_population_level.sh --slow --limit 1
```
...
| Flow                                       | Step | Image |
|--------------------------------------------|------|-------|
| `01_bv_paper_pca_qc_fast`                  | 1    | `ghcr.io/madhavajay/biovault-popgen:0.1.4-fast` |
| `02_bv_paper_gnomad_projection_fast`       | 2    | `ghcr.io/madhavajay/biovault-popgen:0.1.4-fast` |
| `03_bv_paper_sex_biased_admixture_fast`    | 3    | `ghcr.io/madhavajay/biovault-popgen:0.1.4-fast` |
| `04_bv_paper_population_level`             | 4    | `ghcr.io/openmined/biosynth:0.1.27` + `ghcr.io/madhavajay/biovault-popgen:0.1.4-fast` |
