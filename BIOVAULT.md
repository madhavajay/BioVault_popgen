...
```
ghcr.io/madhavajay/biovault-popgen:0.2.0-fast
```

The full image is still built as `ghcr.io/madhavajay/biovault-popgen:0.2.0` for slow/Hail
...
2. **FST** — `container ghcr.io/madhavajay/biovault-popgen:0.2.0-fast`. Load/merge
...
1. **Genotype TXT → VCF** — `container ghcr.io/openmined/biosynth:0.1.30`.
...
`ghcr.io/madhavajay/biovault-popgen:0.2.0-fast` bakes:
...
`ghcr.io/madhavajay/biovault-popgen:0.2.0` bakes:
...
```bash
VERSION=0.2.0 ./build_docker.sh
```

This builds the full image first, then the fast image. It produces:

```text
ghcr.io/madhavajay/biovault-popgen:0.2.0
...
docker build --platform linux/amd64 \
  --target fast-runtime \
  -t ghcr.io/madhavajay/biovault-popgen:0.2.0-fast \
...
```bash
docker tag biovault-popgen:fast ghcr.io/madhavajay/biovault-popgen:0.2.0-fast
IMAGE=ghcr.io/madhavajay/biovault-popgen:0.2.0-fast ./03_individual_level.sh --qc 3
IMAGE=ghcr.io/madhavajay/biovault-popgen:0.2.0-fast ./03_individual_level.sh --fast 3
IMAGE=ghcr.io/madhavajay/biovault-popgen:0.2.0-fast ./03_individual_level.sh --sex 4
IMAGE=ghcr.io/madhavajay/biovault-popgen:0.2.0-fast ./04_population_level.sh --limit 1
```
...
```bash
IMAGE=ghcr.io/madhavajay/biovault-popgen:0.2.0 ./03_individual_level.sh --slow 3
IMAGE=ghcr.io/madhavajay/biovault-popgen:0.2.0 ./03_individual_level.sh --qc --slow 3
IMAGE=ghcr.io/madhavajay/biovault-popgen:0.2.0 ./03_individual_level.sh --sex --slow 4
IMAGE=ghcr.io/madhavajay/biovault-popgen:0.2.0 ./04_population_level.sh --slow --limit 1
```
...
| `05_bv_paper_pgx`                          | 5    | `ghcr.io/openmined/biosynth:0.1.30` + `pgkb/pharmcat` + `ghcr.io/madhavajay/biovault-popgen:0.2.0-fast` |
